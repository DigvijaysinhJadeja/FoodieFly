...
export const GET_ALL_RESTAURANTS_REQUEST = 'GET_ALL_RESTAURANT_REQUEST';
export const GET_ALL_RESTAURANTS_SUCCESS = 'GET_ALL_RESTAURANT_SUCCESS';
export const GET_ALL_RESTAURANTS_FAILURE = 'GET_ALL_RESTAURANT_FAILURE';
...
export const GET_RESTAURANT_BY_USER_ID_REQUEST = 'GET_RESTAURANT_BY_USER_ID_SUCCESS';
export const GET_RESTAURANT_BY_USER_ID_SUCCESS = 'GET_RESTAURANT_BY_USER_ID_SUCCESS';
export const GET_RESTAURANT_BY_USER_ID_FAILURE = 'GET_RESTAURANT_BY_USER_ID_SUCCESS';
...
export const GET_RESTAURANTS_CATEGORY_FAILURE = 'GET_ALL_CATEGORY_FAILURE';
